...
public class SetTeamsInFirstRoundTest {
    @Mock
    Team r1;
    @Mock
    Team r2;
    ...
    @Test
    @DisplayName("Set teams in first round based on seeds")
    void setTeams() {
//        given
        ...
        firstRound.setMatches(List.of(
                ...
                new Match(8)));
//        when
         roundService.setTeamsInFirstRound(firstRound, seedsToTeamMap);

//        then
        assertThat(firstRound.getMatches().get(0).getTeams()).containsAnyElementsOf(List.of(r1, r16));
    }
